...
{
    public class DailyTrade111Controller : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<DailyTrade111Controller> _logger;

        public DailyTrade111Controller(ApplicationDbContext context, ILogger<DailyTrade111Controller> logger)
        {
            _context = context;
            _logger = logger;
        }
